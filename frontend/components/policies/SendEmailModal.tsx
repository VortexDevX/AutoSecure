...
export function SendEmailModal({ isOpen, onClose, policy, onSuccess }: SendEmailModalProps) {
  ...
  // Pre-select existing attachments when policy changes
  useEffect(() => {
    if (isOpen && policy) {
  ...
  // Build available attachments list
  const availableAttachments: PolicyAttachment[] = [];
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="Send Policy Email" size="lg">
      <div className="space-y-6">
        ...
        <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-blue-900">Policy Summary Included</p>
              <p className="text-sm text-blue-800 mt-1">
                A detailed HTML summary of policy <strong>{policy.policy_no}</strong> for customer{' '}
